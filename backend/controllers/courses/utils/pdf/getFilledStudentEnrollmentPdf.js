...
const getFilledStudentEnrollmentPdf = async () => {
  const pdfDoc = await PDFDocument.load(
    await readFile("./data/pdf/inputs/student_enrollment.pdf")
  );
  ...
  await writeFile("./data/pdf/outputs/student_enrollment_output.pdf", pdfBytes);
};

module.exports = getFilledStudentEnrollmentPdf;
